...
class LoadDimensionOperator(BaseOperator):
    """
    Loads dimension table in Redshift from staging table
    :param redshift_conn_id: Redshift connection ID set in Airflow connection
    :param table: Target table in Redshift to load
    :param select_sql: SQL query to get data into target table
    :param delete_load : default False. Able to switch between append-only and delete-load functionality
